# Шифрування та дешифрування методом Віженера
...
def vigenere_encrypt(text, key):
    ...
    for char in text:
        if char.isalpha():
            ...
            encrypted_text.append(char)  # Неалфавітні символи залишаються без змін
...
def vigenere_decrypt(encrypted_text, key):
    ...
    for char in encrypted_text:
        if char.isalpha():
            ...
            decrypted_text.append(char)  # Неалфавітні символи залишаються без змін
