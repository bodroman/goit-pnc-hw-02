# Визначаємо довжину ключа методом Касіскі

import re
from collections import Counter

def kasiski(text):
    # Видаляємо всі пробіли та приводимо до верхнього регістру
    text = re.sub(r'\s+', '', text).upper()
    n = len(text)
    distances = []

    # Шукаємо послідовності довжиною 3 символи
    ...
    # Визначаємо найпоширеніші відстані
    distance_counts = Counter(distances)
    return distance_counts.most_common()

# Зашифрований текст
cipher_text = """VYC PKHOJT XZ RJV AGXOZFR DM ZGRSIBTAC TWPLIJ. 
...
# Запускаємо метод Касіскі
repeats = kasiski(cipher_text)
print(repeats)
